...
export const LoadingSpinner = () => {
    return (
        <div aria-label="Loading..." role="status" className="flex m-auto w-[250px] my-[20px] text-center items-center space-x-2" >
            ...
            <span className="md:text-[13px] lg:text-[20px] font-medium font-integral text-gray-500" > Loading...</span >
        </div >
    )
}